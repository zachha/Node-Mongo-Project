...
exports.getStores = async (req, res) => {
    ...
    res.render('stores', { title: 'Stores', stores, page, pages, count }); // can also use { title: 'Stores', stores: stores }
};
...
exports.getStoresByHearts = async (req, res) => {
    ...
    res.render( 'stores', { title: 'Your Favorites!', stores});
  
};

exports.getTopStores = async (req, res) => {
    const stores = await Store.getTopStores();
    // RULE OF THUMB is to put complex queries inside the MODEL ITSELF and not the CONTROLLER
